package com.standalone.crickboard;
...
import com.standalone.crickboard.database.Datasource;
...
public class ScoreUpdateActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnZero = (Button) findViewById(R.id.zero_run_button);
        btnOne = (Button) findViewById(R.id.one_run_button);
        btnTwo = (Button) findViewById(R.id.two_run_button);
        btnThree = (Button) findViewById(R.id.three_run_button);
        btnFour = (Button) findViewById(R.id.four_run_button);
        btnFive = (Button) findViewById(R.id.five_run_button);
        btnSix = (Button) findViewById(R.id.six_run_button);

        btnBowler = (Button) findViewById(R.id.btn_bowler);
        btnBatsman = (Button) findViewById(R.id.btn_batsman);

        btnOut = (Button) findViewById(R.id.btn_out);
        btnEnd = (Button) findViewById(R.id.btnEnd);

        btnNb = (Button) findViewById(R.id.btn_nb);
        btnWd = (Button) findViewById(R.id.btn_wide);
        btnBye = (Button) findViewById(R.id.btn_bye);
        btnLegBye = (Button) findViewById(R.id.btn_leg_bye);
        ...
        tvTeamOneName = (TextView) findViewById(R.id.team_one_name);
        tvTeamTwoName = (TextView) findViewById(R.id.team_two_name);


        tvTeamOneScore = (TextView) findViewById(R.id.team_one_score);
        tvTeamTwoScore = (TextView) findViewById(R.id.team_two_score);
        tvTeamOneOver = (TextView) findViewById(R.id.tv_over);
        tvTeamOneRunRate = (TextView) findViewById(R.id.tv_runrate);

        tvStriker = (TextView) findViewById(R.id.strikerName);
        tvStrikerScore = (TextView) findViewById(R.id.strikerScore);
        tvStrikerFour = (TextView) findViewById(R.id.strikerFour);
        tvStrikerSix = (TextView) findViewById(R.id.strikerSix);
        tvStrikerStrikeRate = (TextView) findViewById(R.id.strikerStrikeRate);

        tvNonStriker = (TextView) findViewById(R.id.nonStrikerName);
        tvNonStrikerScore = (TextView) findViewById(R.id.nonStrikerScore);
        tvNonStrikerFour = (TextView) findViewById(R.id.nonStrikerFour);
        tvNonStrikerSix = (TextView) findViewById(R.id.nonStrikerSix);
        tvNonStrikerStrikeRate = (TextView) findViewById(R.id.nonStrikerStrikeRate);

        tvCommentry = (TextView) findViewById(R.id.commentry);

        tvBowlerName = (TextView) findViewById(R.id.bowlerName);
        tvBowlerOver = (TextView) findViewById(R.id.bowlerOver);
        tvBowlerRun = (TextView) findViewById(R.id.bowlerRun);
        tvBowlerWicket = (TextView) findViewById(R.id.bowlerWicket);
        tvBowlerEconomyRate = (TextView) findViewById(R.id.bowlerEconomyRate);

        tvThisOver = (TextView) findViewById(R.id.thisOver);
        ...
        tvCommentry.setText(teamOne.name + " won the toss & elected to bat first");
    }
    ...
    public void onClick(View v) {
        ...
        if (isTeamTwoInBatting) {
            ...
            tvCommentry.setText(teamOne.name + " needs " + targetRun + " from " + ballsRemain + " balls to win");
        }
